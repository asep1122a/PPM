<x-guest-layout>
    ...
    <div class="w-full min-h-screen flex flex-col justify-center items-center text-center bg-center bg-no-repeat bg-cover"
        ...
        <h1
            class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-yellow-400 sm:leading-none lg:text-5xl">
            <span class="inline md:block">SELAMAT DATANG DI RESTO & CAFE MAS BRO</span>
        </h1>
        <div class="mt-2 text-green-50 lg:text-lg">
            “Nikmati cita rasa khas di Resto & Cafe Mas Bro, tempat makan favorit dengan pelayanan ramah dan harga
            bersahabat.”
        </div>
        ...
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            ...
                            Kami hadir untuk menyuguhkan pengalaman kuliner khas dengan suasana hangat dan pelayanan
                            ramah.
        ...
        <section class="px-6 lg:px-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4">
                ...
                <div
                    ...
                    <p class="text-gray-600 text-sm mt-1">Pilihan makanan tradisional khas Indonesia yang menggugah
                        selera.</p>
                ...
                <div
                    ...
                    <p class="text-gray-600 text-sm mt-1">Minuman dingin menyegarkan dengan berbagai pilihan rasa buah.
                    </p>
                    <div class="flex justify-between items-center mt-3">
                ...
                <div
                    ...
                    <p class="text-gray-600 text-sm mt-1">Lingkungan yang tenang dan nyaman, ideal untuk bersantai atau
                        bekerja.</p>
                    <div class="flex justify-between items-center mt-3">
                ...
                <div
                    ...
                    <p class="text-gray-600 text-sm mt-1">Staf kami siap melayani dengan senyum dan keramahan setiap
                        saat.</p>
                    <div class="flex justify-between items-center mt-3">
